    ...
    <Box>
      <Card className="contractor-card" variant="outlined">
        ...
        <div className="contractor-card-lists-container">
          {data.specialties?.length > 0 && (
            <Accordion className="contractor-specialties-list">
              <AccordionSummary
                ...
                id="contractor-specialties-accordion-summary"
              >
              ...
              <AccordionDetails className="contractor-specialties">
                {data.specialties.map((specialty, i) => (
                  <Typography
                    ...
                    component="p"
                    variant="caption"
                    className="contractor-list-item"
                  >
                    {specialty}
                  </Typography>
                ))}
          ...
          {data.certifications?.length > 0 && (
            <Accordion className="contractor-certifications-list">
              <AccordionSummary
                expandIcon={<ExpandMoreIcon />}
                id="contractor-certifications-accordion-summary"
              >
                <Typography component="h4" variant="subtitle1">
          ...
          {data.tools?.length > 0 && (
            <Accordion className="contractor-tools-list">
              <AccordionSummary
                expandIcon={<ExpandMoreIcon />}
                id="contractor-tools-accordion-summary"
              >
                <Typography component="h4" variant="subtitle1">
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <Link to={`/profile/${data.id}`} style={{ textDecoration: "none" }}>
            <Button
              className="contact-contractor-button"
              variant="contained"
              color="primary"
            >
              Contact
