...
function Job() {
    ...
    <Card>
      ...
      <div style={{ display: "flex", justifyContent: "center", padding: 5 }}>
        <form>
          ...
          <input
            type="text"
            placeholder="What you want contractors to see"
            style={inputStyle}
              ...
              return (
                <span key={i}>
                  ...
                  <input
                    ...
                    defaultChecked={!!specialtiesSelected[item]}
                  />{" "}
                  {item} <br />
                </span>
              );
          ...
          <Button onClick={goToConfirm} variant="contained">
            Post
          </Button>
          <br />
        </form>
  ...
  const confirmPage = (
    <Card>
      <div style={{ textAlign: "center", padding: 5 }}>
        ...
        <br />
        <ul>
          {Object.keys(specialtiesSelected).map((item) => (
            <li key={item}>
  ...
  function goToConfirm(e) {
    ...
    if (
      ...
      description &&
      price_per_hour &&
      Object.keys(specialtiesSelected).length
    ) {
  ...
  function handleConfirm(e) {
    ...
    if (editMode) {
      editJobs({
        ...
        title,
        description,
        specialties: Object.keys(specialtiesSelected),
        date: new Date(),
        price_per_hour,
      });
    } else {
  ...
  return (
    <Container>
      <br />
      <div style={{ padding: 5 }}>{confirmation ? confirmPage : formPage}</div>
    </Container>
  );
}
